...
export default function SwapPage() {
  ...
  return (
    <>
      ...
      <div className="">
        <div
          className="relative min-h-screen flex justify-center items-center p-4 overflow-hidden bg-cover bg-center"
          style={{
        ...
        >
          ...
          {/* Swap Box */}
          <div className="relative bg-slate-800/50 backdrop-blur-xl rounded-3xl border border-slate-700/50 p-6 shadow-2xl w-[450px]">
            {/* Logo công ty */}
            ...
            <div className="bg-gray-700 p-4 rounded-xl mb-3">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setAmount(
                    val <= 0 ? '' : val >= availableUsdt ? availableUsdt : val,
                  );
                }}
                placeholder="0.0"
