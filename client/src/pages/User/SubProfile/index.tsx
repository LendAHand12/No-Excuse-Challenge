...
const SubProfilePage = () => {
  ...
  useEffect(() => {
    (async () => {
      setLoading(true);
      await User.getListChildSubUser()
        .then((response) => {
      ...
      >
        ...
        {loading ? (
          ...
          <>
                  ...
                  <div className="py-2 px-4">
                    ...
                    <div className="lg:py-2">
                      <ul className="flex flex-row flex-wrap gap-2">
                        {subInfo?.listDirectUser.map((ele) => (
            ...
            <div>
              <p className="text-xl font-bold text-center mt-10 mb-3">
                Referral
              </p>
              <div className="mb-3">
                <div>
