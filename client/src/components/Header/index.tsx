...
const Header = (props: {
  ...
  return (
    <header className="absolute top-0 z-9 flex w-full bg-black lg:bg-transparent">
      <div className="flex flex-grow items-center justify-between lg:justify-end px-4 py-4 gap-4 md:px-6 2xl:px-11">
        <NavLink to="/" className="hidden sm:block lg:hidden">
        ...
        <div className="flex items-center gap-3 2xsm:gap-6">
          ...
          <div className="flex items-center gap-2 sm:gap-4 lg:hidden">
            <button
              ...
              className="z-9 block p-1.5 shadow-sm dark:border-strokedark lg:hidden"
            >
