    ...
    icon: (
      ...
      >
        <g clipPath="url(#clip0_1_180)">
          <path
            d="M20 12.5V6.249C20.0001 6.17006 19.9845 6.09189 19.9543 6.01896C19.9241 5.94603 19.8798 5.87978 19.824 5.824L16.676 2.676C16.5636 2.56345 16.4111 2.50014 16.252 2.5H4.6C4.44087 2.5 4.28826 2.56321 4.17574 2.67574C4.06321 2.78826 4 2.94087 4 3.1V21.9C4 22.0591 4.06321 22.2117 4.17574 22.3243C4.28826 22.4368 4.44087 22.5 4.6 22.5H13M8 10.5H16M8 6.5H12M8 14.5H11"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
          <path
            d="M16 2.5V5.9C16 6.05913 16.0632 6.21174 16.1757 6.32426C16.2883 6.43679 16.4409 6.5 16.6 6.5H20M19.992 15.625L22.548 16.274C22.814 16.342 23.001 16.584 22.993 16.858C22.821 22.616 19.5 23.5 19.5 23.5C19.5 23.5 16.179 22.616 16.007 16.858C16.0043 16.7247 16.0468 16.5944 16.1276 16.4883C16.2084 16.3823 16.3227 16.3067 16.452 16.274L19.008 15.625C19.331 15.543 19.669 15.543 19.992 15.625Z"
            stroke="currentColor"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 lg:z-0 flex h-screen w-96 flex-col overflow-y-auto bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <img src={Logo} alt="Logo" className="lg:w-64 w-54" />
        </NavLink>
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              {routes.map((route: Route) => (
                <li key={route.title}>
                  <NavLink
                    to={route.link}
                    className={`group relative flex items-center rounded-s-2xl gap-8 py-3 pl-6 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
      ...
      <div className="lg:absolute lg:bottom-10 lg:left-8 p-10 lg:p-0">
        <img src={COVER3} />
