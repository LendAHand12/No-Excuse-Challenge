...
const userOldSchema = mongoose.Schema(
  {
    userId: {
      type: String,
      required: true,
...
userOldSchema.methods.matchPassword = async function (enteredPassword) {
...
const UserOld = mongoose.model("UserOld", userOldSchema);
